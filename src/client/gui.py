...
class GUI:
	...
	def __init__(self, master, animalProfilePath):
		...
		self.spinbox1 = Spinbox(frameLimBox, from_=0, to=3000, command=self.update_spinbox1)
		self.spinbox1.pack(padx=38,side=LEFT)
		self.spinbox2 = Spinbox(frameLimBox, from_=0, to=3000, command=self.update_spinbox2)
		self.spinbox2.pack(padx=38,side=LEFT)
		self.spinbox3 = Spinbox(frameLimBox, from_=0, to=3000, command=self.update_spinbox3)
		self.spinbox3.pack(padx=38,side=LEFT)
		self.spinbox4 = Spinbox(frameLimBox, from_=0, to=3000, command=self.update_spinbox4)
		self.spinbox4.pack(padx=38,side=LEFT)
		self.spinbox5 = Spinbox(frameLimBox, from_=0, to=3000, command=self.update_spinbox5)
